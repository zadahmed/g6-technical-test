...
class FeedbackFormTest(TestCase):
    def test_incorrect_email(self):
        ...
        self.assertTrue("Only Cabinet Office email addresses are allowed." in str(email_errors))

    def test_correct_email(self):
        valid_cabinet_email = "valid@cabinetoffice.gov.uk"
        form = forms.FeedbackForm({"email": valid_cabinet_email, "content": "some feedback"})
        form.is_valid()
